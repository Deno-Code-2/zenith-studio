    ...
    <section className="py-12 md:py-20 bg-black">
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        <div className="relative min-h-[400px] w-full overflow-hidden rounded-lg border border-custom-orange/20 bg-gradient-to-br from-black via-custom-orange/10 to-black">
          <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 md:p-8 lg:p-10">
            ...
            <p className="text-lg text-white font-jakarta max-w-2xl text-center mb-6">
            ...
            <p className="text-base text-white/90 font-jakarta mb-6">
