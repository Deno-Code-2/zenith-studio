  ...
  return <div className="py-20 bg-black">
      <div className="container mx-auto px-8 lg:px-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-custom-orange-300 max-w-2xl mx-auto font-jakarta">
...
const Feature = ({
  ...
  return <div className={cn("flex flex-col lg:border-r py-10 relative group/feature dark:border-neutral-800", 
    ...
    index < 4 && "lg:border-b dark:border-neutral-800")}>
      ...
      <div className="mb-4 relative z-10 px-10 text-neutral-600 dark:text-neutral-400 group-hover/feature:text-custom-orange transition-colors">
        {icon}
      </div>
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-custom-orange transition-all duration-200 origin-center" />
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-gray-50 font-syne group-hover/feature:text-custom-orange">
          {title}
        </span>
      </div>
      <p className="text-sm max-w-xs relative z-10 px-10 text-orange-50 font-jakarta">
        {description}
      </p>
    </div>;
};
