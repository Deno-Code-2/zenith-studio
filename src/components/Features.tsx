    ...
    <div className="py-16 sm:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-16">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-custom-orange mb-4 sm:mb-6 font-syne">
            The Arsenal
          </h2>
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-3 sm:mb-4 relative z-10 px-6 sm:px-8 lg:px-10 text-gray-600 group-hover/feature:text-custom-orange transition-colors">
        {icon}
      </div>
