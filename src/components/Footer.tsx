...
import { Github, Twitter, Instagram, Linkedin, AtSign } from 'lucide-react';
  ...
  return (
    <footer className="w-full bg-black py-20">
      <div className="container mx-auto px-8 lg:px-16">
        ...
        {/* Large Website Name */}
        <div className="pt-16 border-t border-gray-800 relative overflow-hidden">
          <h1 className="text-[20vw] font-bold text-center opacity-5 font-syne select-none overflow-visible">
