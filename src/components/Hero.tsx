    ...
    <div className="min-h-[calc(100vh-120px)] flex items-center justify-center px-8 lg:px-16">
      <div className="max-w-4xl text-center space-y-8 animate-fadeIn" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="flex justify-center">
          <ActionButton 
            href="#start-project" 
            className="text-lg px-8 py-4 rounded-full hover:translate-y-[-2px] transition-all duration-200 bg-moss-green text-dark-green font-jakarta font-medium"
          >
            Let's connect
          </ActionButton>
        </div>
        ...
        <div className="mt-20">
          <h3 className="text-3xl font-bold text-mindaro mb-10 font-syne">My Achievements</h3>
          <div className="flex flex-wrap justify-center gap-12 text-center">
            <div className="achievement-item">
              <span className="block text-4xl font-bold text-moss-green font-syne">260</span>
              <span className="text-gray-300 font-jakarta">Happy Customers</span>
            </div>
            <div className="achievement-item">
