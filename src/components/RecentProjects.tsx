...
const RecentProjects = () => {
  ...
  if (isLoading) {
    return <section className="py-20 bg-gradient-to-b from-hunter-green to-dark-green">
  ...
  return <section className="py-20 bg-gradient-to-b from-hunter-green to-dark-black bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects?.map(project => <div key={project.id} className="group relative overflow-hidden rounded-xl bg-fern-green/10 backdrop-blur-sm border border-moss-green/20 transition-all duration-300 hover:border-moss-green/40">
              <div className="relative">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <a href={project.project_url} className="text-moss-green hover:text-mindaro transition-colors" target="_blank" rel="noopener noreferrer">
