  ...
  const tabContent = [
    {
      ...
      content: (
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl font-bold text-black mb-4 font-syne">Shaping Digital Futures</h3>
            <p className="text-black leading-relaxed mb-4 font-jakarta">
            ...
            <div className="flex flex-col space-y-3 mt-6">
              <div className="flex items-center gap-3">
                ...
                <p className="text-black font-jakarta">Leading the industry with innovative solutions</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-custom-orange/10 flex items-center justify-center flex-shrink-0">
                  <Lightbulb className="w-4 h-4 text-custom-orange" />
                </div>
                <p className="text-black font-jakarta">Setting new standards in digital experience design</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">We begin by understanding your business, goals, and vision through in-depth consultations.</p>
            </div>
            ...
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">Our team creates a strategic roadmap and detailed specifications for your project.</p>
            </div>
            ...
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">We craft stunning, functional designs that align with your brand and user expectations.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">Our developers bring designs to life with clean, efficient, and scalable code.</p>
            </div>
            ...
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">Rigorous quality assurance ensures your project works flawlessly across all devices.</p>
            </div>
            ...
            <div className="bg-black/30 border border-custom-orange/20 p-6 rounded-xl hover:border-custom-orange/40 transition-all">
              ...
              <p className="text-black font-jakarta">We deploy your project and provide ongoing support to ensure continued success.</p>
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <p className="text-black leading-relaxed font-jakarta max-w-3xl">
          ...
          <div className="flex items-center justify-center mt-8">
            <div className="flex items-center gap-3 bg-black/30 border border-custom-orange/20 rounded-xl px-6 py-3">
              ...
              <p className="text-black font-jakarta">We're always looking for talented individuals to join our team</p>
            </div>
          </div>
        </div>
      )
      ...
      content: (
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1">
            <h3 className="text-2xl font-bold text-black mb-4 font-syne">Work Culture at Zenith</h3>
            <p className="text-black leading-relaxed mb-4 font-jakarta">
            ...
            <div className="space-y-4 mt-6">
              <div className="bg-black/30 border border-black p-4 rounded-xl">
                <h4 className="text-lg font-bold text-orange-500 mb-2 font-syne">Innovation Days</h4>
                <p className="text-black font-jakarta">Regular days dedicated to exploring new technologies and creative concepts.</p>
              </div>
              
              <div className="bg-black/30 border border-black p-4 rounded-xl">
                <h4 className="text-lg font-bold text-orange-500 mb-2 font-syne">Knowledge Sharing</h4>
                <p className="text-black font-jakarta">Weekly workshops and presentations led by team members to share expertise.</p>
              </div>
              
              <div className="bg-black/30 border border-black p-4 rounded-xl">
                <h4 className="text-lg font-bold text-orange-500 mb-2 font-syne">Work-Life Balance</h4>
                <p className="text-black font-jakarta">Flexible scheduling and remote work options to support overall wellbeing.</p>
              </div>
            </div>
          </div>
