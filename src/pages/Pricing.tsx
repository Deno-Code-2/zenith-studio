...
//const Pricing = () => {
  ...
  //return (
    //<main className="min-h-screen bg-white">
      ...
      //</main><section className="pt-28 pb-20 px-4">
...
const Pricing = () => {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="flex justify-center items-center min-h-[60vh] text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-black font-syne text-center justify-center">
          Coming Soon
        </h1>
      </section>
